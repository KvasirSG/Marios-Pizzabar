...
public class Order implements Serializable {
    ...
    // Constructor for the Order object, provides ID for the order as well as
    // initializing the ArrayList "Pizzas"
    ...
    // ID from timestamp method, to allow individual ID of the order instead of
    // using Hashmap
